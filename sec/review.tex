...
mining~\cite{Arnolds2018,Prokofyeva2020,Rebuge2012}, and patient
flow~\cite{Bhattacharjee2014}. Regardless of the advantages of simulation
models, a prerequisite is reliable software with which to construct those
...
Often, clustering forms a fundamental part of these methodologies, rationalising
an otherwise vast, heterogeneous set of behaviours. As an
example,~\cite{Prokofyeva2020} uses hierarchical clustering is used to group
clinical pathways which, in turn, informs a broader, adaptive patient flow model.
Meanwhile,~\cite{Rebuge2012} considers a pathway as a sequence of events sampled
