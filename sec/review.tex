...
% TODO Careful with names and citations, when they go in to a journal's style
% file you might end up duplicating the names, (I'd just omit them).
...
% TODO Same comment about names and citations.
...
fundamental methods.  % TODO Can we have a reference or 2 here to backup claim that they're still fundamental? (Perhaps even the initialisation paper of yours.
...
% TODO Let us point at a text book here.
...
% TODO We should reference your paper here.
...
% TODO Just double checking the \# is correct and not a typo
...
% TODO Add a pointer to previous section: "which was discussed in ..."
...
% TODO We should point at other healthcare modelling literature reviews that are
% out there.
...
% TODO This is certainly the type of sentence that is often included when
% discussing this. However I have often argued that the visulisation can in fact
% be unhelpful as it can accentuate biaises. I also argue that the correct
% visualisations of the output of any simulation are more important the the nice
% shiny things moving around. I don't suggest you change this as I have no
