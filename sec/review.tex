...
decision-making processes allows healthcare practitioners and researchers make
full use of the sheer volume of information available in increasingly complex
healthcare
settings~\cite{Alexander2018,Belle2015,Taranu2016,Tomar2013,Tsui2015}. However,
since these methods directly impact the well-being of humans --- perhaps in an
unaudited manner --- any data-driven model applied in healthcare requires a
richer evaluation process to be deemed
...
The authors of~\cite{Char2020} present a systematic approach to evaluating the
ethical quality of a machine learning application in healthcare, which has
proven influential in recent works. They offer a framework distilled from the
literature on ethical considerations in machine learning applications in
healthcare and non-healthcare settings. The framework organises and accounts for
an array of concerns relevant to healthcare, including societal biases,
