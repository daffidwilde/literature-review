...
centre~\cite{Bradley1997,Arya2001}; this mitigates the effect of outliers.
...
further from one another, thus loosening any sense of homogeneity. Hence,
...
dependent on the eigenvalues of a dataset's covariance
matrix~\cite{Mahalonobis1936}; a potential downside to this measure is the
