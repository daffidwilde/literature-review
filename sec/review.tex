...
methods following work by Sokal~\cite{Sokal1966} (and later with
...
part of statistics. Furthermore, this period witnessed the advent of seminal and
presently fundamental clustering algorithms such as the \(k\)-means
paradigm~\cite{Hartigan1979} and hierarchical
